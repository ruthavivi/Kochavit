...
implementation
uses
  Main, DataDM, LogErrorUtil, GnrlFreze, DialogsHeb, ClientEditDM, ClientEdit,
  CarListDM, DriverListDM, BillListDM, ChecksListDM, WrnSendMsg, LikuySendMsg,
  Cause, StatusCars, StatusDrvs, MainDM;
{$R *.dfm}
...
begin
  if (dmMain.qrClientListDept.AsString = '') then
  begin
    ...
    MessageDlgH('לא ניתן לעביר לארכיון חברה עם חוב כספי', mtInformation, [mbYes], 0, 0);
end;
