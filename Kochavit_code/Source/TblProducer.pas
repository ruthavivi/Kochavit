...
uses
  ...
  ExtCtrls, ComCtrls, StdCtrls, DBCtrls, ToolWin, edbcomps, StdActns,
  MyChkDBGrid, frxClass, frxDBSet, System.Actions, System.ImageList;
...
begin
  inherited;
   try
       ...
       begin
           tbTblScnd.Close;
           HandelError('TfrmProducerTbl.FormCreate', '!!! קיים קובץ לא תקין' + #10#13 + E.Message, E);
           Self.Destroy;
       end;
   end;
end;
