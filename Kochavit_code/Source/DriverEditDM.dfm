inherited dmDriverEdit: TdmDriverEdit
  ...
  object tbDriver: TEDBTable
    ...
    object tbDriverCodDrv: TAutoIncField
      FieldName = 'CodDrv'
      OnValidate = tbDriverCodDrvValidate
    end
    ...
    object tbDriverEMail: TStringField
      FieldName = 'EMail'
      Size = 30
    end
  ...
  object tbDrAcdnt: TEDBTable
    ...
    object tbDrAcdntTipul: TStringField
      DisplayLabel = #1496#1497#1508#1493#1500
      FieldName = 'Tipul'
      Size = 50
    end
