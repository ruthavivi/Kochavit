...
uses
  ...
  Vcl.Menus, System.Actions, System.ImageList;
...
procedure TfrmClientListArhiv.acExcelExecuteExecute(Sender: TObject);
var
  FileName: String;
begin
  inherited;
  if SelectFields('Ac', dmClientListArhiv.qrList) then
    if GetExprtFile(FileName, 'Excel', 2) then
      SaveToExcel(dmClientListArhiv.qrList, FileName);
end;
