...
uses
  SysUtils, Classes, DB, TrapActionUtils, Dialogs, edbcomps;
...
//  Result := False;
  ...
  begin
    ...
    begin
      ...
      begin
        Result := True;
        MessageDlgH('הערך ' + pMsgVal + ' בשימוש ואינו ניתן למחיקה ',
              mtError, [mbOK], 0, 0);
        Close;
        Break;
      end;
...
begin
  ...
  try
    ...
    begin
      Result := True;
      MessageDlgH('הערך ' + pValue + ' קיים כבר', mtError, [mbOK], 0, 0);
    end;
  finally
    qrGnrl.Close;
  end;
