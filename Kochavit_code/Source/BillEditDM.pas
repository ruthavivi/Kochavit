...
uses
  Windows, SysUtils, GnrlEditDM, DB, Classes, edbcomps;
...
begin
  inherited;
  if (tbBill.State = dsInsert) then
    BillId := '-1'
  else
    BillId := tbBillId.AsString;

  if CheckDblValue('KBill', Sender.FieldName, Sender.Text, BillId,
