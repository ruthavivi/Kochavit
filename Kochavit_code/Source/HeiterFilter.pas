...
procedure TfrmHeiterFilter.cbEShemEnter(Sender: TObject);
var
  ListItem: TStringList;
begin
  ListItem := TStringList.Create;
...
procedure TfrmHeiterFilter.cbEOvedEnter(Sender: TObject);
begin
  inherited;
  LoadItemsInComboBox(Sender, '');
end;
...
procedure TfrmHeiterFilter.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  frmHeiterFilter := nil;
end;
