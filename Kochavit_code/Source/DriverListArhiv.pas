...
uses
  ...
  System.Actions, Vcl.Menus, System.ImageList;
...
procedure TfrmDriverListArhiv.acExcelExecuteExecute(Sender: TObject);
var
  FileName: String;
begin
  inherited;
  if SelectFields('Ad', dmDriverListArhiv.qrList) then
    if GetExprtFile(FileName, 'Excel', 2) then
      SaveToExcel(dmDriverListArhiv.qrList, FileName);
end;
