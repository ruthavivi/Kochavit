...
begin
  if not Assigned(frmClientFilter) then
    ...
    MessageDlgH('דו"ח חברות כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmCarFilter) then
    ...
    MessageDlgH('דו"ח רכבים כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmTipulFilter) then
    ...
    MessageDlgH('דו"ח טיפולים כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmDriverOnCarFilter) then
    ...
    MessageDlgH('דו"ח נהגים צמודים כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmAcdntFilter) then
    ...
    MessageDlgH('דו"ח תאונות כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmDriverFilter) then
    ...
    MessageDlgH('דו"ח נהגים כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmHeiterFilter) then
    ...
    MessageDlgH('דו"ח היתרים כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmTahoFilter) then
    ...
    MessageDlgH('דו"ח בדיקות טכוגרף כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmAviraFilter) then
    ...
    MessageDlgH('דו"ח עבירות כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmCourseFilter) then
    ...
    MessageDlgH('דו"ח קורסים כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmBdikaFilter) then
    ...
    MessageDlgH('דו"ח בדיקות כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if not Assigned(frmAnualTipulFilter) then
    ...
    MessageDlgH('דו"ח תוכנית שנתית כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  ...
  if not Assigned(frmBillFilter) and CheckPassword then
    ...
    MessageDlgH('דו"ח חשבונות כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  ...
  if not Assigned(frmChecksFilter) and CheckPassword then
    ...
    MessageDlgH('דו"ח המחאות כבר פתוח', mtError, [mbOk], 0, 0);
end;
...
begin
  if (Role = 'Admin') then
    ...
    MessageDlgH('אין הרשאה לעדכן סעיף זה', mtError, [mbOk], 0, 0);
end;
