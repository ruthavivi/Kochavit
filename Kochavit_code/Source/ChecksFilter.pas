...
type
  TfrmChecksFilter = class(TfrmGnrlFilter)
    ...
    procedure cbEBankEnter(Sender: TObject);
...
implementation
uses
  ChecksFilterDM, ChecksReport, KbFunc;
{$R *.dfm}
...
procedure TfrmChecksFilter.cbEBankEnter(Sender: TObject);
begin
  inherited;
...
procedure TfrmChecksFilter.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  frmChecksFilter := nil;
end;
