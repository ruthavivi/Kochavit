...
begin
  ...
  if (FileExists(Path + ImportRec.NoBkr + '.Pdf')) then
    dmGnrlBig.SaveBigData(StrToInt(CarId), 'CarId', Path+ImportRec.NoBkr + '.Pdf',
        ImportRec.NoBkr, 'FromMasofon', True);
  if (FileExists(Path + ImportRec.NoBkr + '.Jpg')) then
    dmGnrlBig.SaveBigData(StrToInt(CarId), 'CarId', Path+ImportRec.NoBkr + '.Jpg',
        ImportRec.NoBkr, 'FromMasofon', True);
end;
