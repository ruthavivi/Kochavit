...
type
  TfrmDefault = class(TForm)
    ...
    tbDefaultUserEMail: TStringField;
    edBody: TDBMemo;
    tbDefaultTel1: TStringField;
    tbDefaultTel2: TStringField;
    edTel1: TDBEdit;
    Label19: TLabel;
    Label21: TLabel;
    edTel2: TDBEdit;
    tbDefaultPreferedDir: TStringField;
    Label22: TLabel;
    edPrefferedDir: TDBEdit;
    TabSheet5: TTabSheet;
    GroupBox4: TGroupBox;
    Label23: TLabel;
    edDatabase: TDBEdit;
    tbDefaultDatabase: TStringField;
    tbDefaultDataUserName: TStringField;
    tbDefaultDataPassword: TStringField;
    tbDefaultServer: TStringField;
    edDataUserName: TDBEdit;
    Label24: TLabel;
    edDataPassword: TDBEdit;
    Label25: TLabel;
    edServer: TDBEdit;
    Label26: TLabel;
    tbDefaultAppPath: TStringField;
    edAppPath: TDBEdit;
    Label27: TLabel;
    Label28: TLabel;
    DBRadioGroup1: TDBRadioGroup;
    tbDefaultLastSync: TStringField;
    tbDefaultReportClient: TIntegerField;
...
begin
  ...
  else if dbcEmailComp.Text = 'Outlook' then
  begin
    edHost.Text := 'smtp-mail.outlook.com';
    edHost.Enabled := False;
    edPort.Text := '587';
    edPort.Enabled := False;
    dbcAuthType.Text := 'satDefault';
