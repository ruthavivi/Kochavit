object dmMain: TdmMain
  ...
  object qrWrnCar: TEDBQuery
    ...
    Left = 64
    Top = 96
    object qrWrnCarclSign: TStringField
      DisplayWidth = 1
      FieldKind = fkCalculated
      FieldName = 'clSign'
      OnGetText = qrWrnCarclSignGetText
      Size = 1
      Calculated = True
    end
    ...
    object qrWrnCarProblem: TBooleanField
      DisplayWidth = 5
      FieldName = 'Problem'
    end
    ...
    object qrWrnCarCarId: TIntegerField
      FieldName = 'CarId'
    end
  ...
  object qrWrnDrv: TEDBQuery
    ...
    SQL.Strings = (
        ...
        'elD, Shem, Tel1, Oved, Problem, Dr.LicenceNum, tLc.Licence'
      'FROM KDrHeiter Dh'
      ...
      'LEFT JOIN KTblLicence tLc ON Dr.LicenceId = tLc.Id'
    ...
    object qrWrnDrvLicenceNum: TStringField
      DisplayLabel = #1502#1505#39' '#1512#1497#1513#1497#1493#1503
      FieldName = 'LicenceNum'
      Size = 7
    end
    object qrWrnDrvLicence: TStringField
